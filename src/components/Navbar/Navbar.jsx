...
import './Navbar.css'
//import logo from '../../Portfolio_React_Assets/assets/logo.svg'
    ...
    <div className='navbar'>
        ...
        <ul ref={menuRef} className='nav-menu'>
          <img src={menu_close} onClick={closeMenu} alt="" className="nav-mob-close" />
            ...
            <li><AnchorLink className='anchor-link' offset={100} href='#services'><p onClick={()=>{setMenu("services")}}>Interests</p></AnchorLink>{menu==='services'?<img src={underline} alt=''/>:<></>}</li>
            <li><AnchorLink className='anchor-link' offset={100} href='#projects'><p onClick={()=>{setMenu("projects")}}>Projects</p></AnchorLink>{menu==='projects'?<img src={underline} alt=''/>:<></>}</li>
